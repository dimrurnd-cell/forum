...
Кегли здесь крупнее, чем на остальных размерах: пост смотрят с телефона
и чаще всего на ходу. Заголовок 100 px, подзаголовок 34 px, строка
с призывом 28 px — всё читается с вытянутой руки. Поэтому на макете
только то, что успевают прочитать: название, что разбираем, где и когда,
цена и лица. Программа и этапы — в тексте под постом.
